...
ALTER FUNCTION public.concat(character varying, integer) OWNER TO postgres;
...
ALTER FUNCTION public.concat(character varying, bigint) OWNER TO postgres;
...
ALTER FUNCTION public.createchampionship(integer, text) OWNER TO postgres;
...
ALTER FUNCTION public.generategroupmatches(bigint) OWNER TO postgres;
...
ALTER TABLE public.groupstage OWNER TO postgres;
...
ALTER FUNCTION public.generategroupstage() OWNER TO postgres;
...
ALTER FUNCTION public.generateknockouttree(integer, bigint) OWNER TO postgres;
...
ALTER FUNCTION public.generatematch(bigint, bigint, bigint) OWNER TO postgres;
...
ALTER FUNCTION public.generateteam() OWNER TO postgres;
...
CREATE FUNCTION getcountry() RETURNS SETOF country
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION public.getcountry() OWNER TO postgres;
...
ALTER FUNCTION public.getnextsequence() OWNER TO postgres;
...
ALTER FUNCTION public.getplayer() OWNER TO postgres;
...
ALTER FUNCTION public.getstadiumsforcountry(bigint) OWNER TO postgres;
...
ALTER TABLE public.actor_permission OWNER TO postgres;
...
ALTER TABLE public.groupstage_tournamentgroup OWNER TO postgres;
...
ALTER TABLE public.match_matchevent OWNER TO postgres;
...
ALTER TABLE public.team_advisor OWNER TO postgres;
...
ALTER TABLE public.tournament_country OWNER TO postgres;
...
ALTER TABLE public.tournament_stadium OWNER TO postgres;
...
ALTER TABLE public.tournamentgroup OWNER TO postgres;
...
ALTER TABLE public.tournamentgroup_match OWNER TO postgres;
...
ALTER TABLE public.tournamentgroup_team OWNER TO postgres;
