...
\item Lösche falls vorhanden die Datenbank {\it test} 

\item Erstelle das Schema (mit Tabellen und Funktionen) aus der Datei {\tt dump.sql}
\begin{verbatim}psql --username=postgres -h localhost < doc/sql/dump.sql\end{verbatim}
