...
public class PlayerService {
	 ...
	 */
	public static Tuple<Tuple<Integer>> playerOnField(Player player, Match match) throws PlayerDoesNotPlay{
		...
		if(match.getClass() == KnockoutMatch.class){
			if(((KnockoutMatch)match).getExtraTime())
				out = new Tuple<Integer>(120, ((KnockoutMatch)match).getAddTimeForth());
		}
		else
