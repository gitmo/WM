...
public class TeamService {
	...
	public static List<Player> getPlayingPlayersForTeam(Match match,
			Team team) {

		List<Player> playingPlayers = MatchService.getLineupForTeam(team, match);
		int i;
		for(Tuple<Player, Player> substitution : MatchService.getSubstitutedPlayersByTeam(team, match)) {
		...
		System.out.println("getPlayingPlayersForTeam: "+playingPlayers.size());
